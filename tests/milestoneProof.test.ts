...
describe('Milestone Proof of Work', () => {
  ...
  it('should allow submitting proof of work for a milestone', async () => {
    ...
    await engine.submitMilestoneProof('prop-1', 'm1', 'https://proof.url/123');
  ...
  it('should throw error if proposal not found', async () => {
    await expect(engine.submitMilestoneProof('non-existent', 'm1', 'https://proof.url'))
