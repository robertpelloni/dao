 ...
 */
export declare function calculateVoteCost(votes: number): number;
/**
 ...
 */
export declare function calculateVotesFromCredits(credits: number): number;
/**
 ...
 */
export declare function aggregateVotes(voteCounts: number[]): number;
//# sourceMappingURL=qv.d.ts.map